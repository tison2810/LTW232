<?php
	...
	if (isset($_POST['submit'])) {
        ...
        $sqlUpdate = "UPDATE oto SET Ten = ?, Anh1 = ?, Anh2 = ?, Anh3 = ?, Anh4 = ?, MoTa = ?, GiaGomPin = ?, Dai = ?, CongSuat = ?, QuangDuongDiChuyen = ? WHERE ID = ?";

        $stmt = $conn->prepare($sqlUpdate);

        $stmt->bind_param('ssssssssssi', $name, $anh1, $anh2, $anh3, $anh4, $desc, $price, $length, $power, $distance, $id);
