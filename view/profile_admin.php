        ...
        <div class="profile">
            ...
            <div class="sidebar">
                <div class="sidebar-item">QUẢN LÝ HỆ THỐNG</div>
                    <a class="item-select" href="/customer_management">Quản lý khách hàng</a><br>
                    <a class="item-select" href="car_management">Quản lý ô tô</a><br>
                    <a class="item-select" href="bike_management">Quản lý xe máy điện</a><br>
			...
			<?php
                        ...
                        switch ($action) {
                            ...
                            case 'customer_management':
                                require_once 'customer_management.php';
                                break;
                            case 'car_management':
                                require_once 'car_management.php';
                                break;
                            case 'bike_management':
                                require_once 'bike_management.php';
                                break;
