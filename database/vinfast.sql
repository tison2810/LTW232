...
ADD CONSTRAINT FK__ThemOto_TDN FOREIGN KEY (Email) REFERENCES NguoiDung(Email),
...
ADD CONSTRAINT FK__ThemXeMay_TDN FOREIGN KEY (Email) REFERENCES NguoiDung(Email),
...
ALTER TABLE DonHang
ADD CONSTRAINT FK__DonHang__TDN FOREIGN KEY (Email) REFERENCES NguoiDung(Email);
